...
export default function DishManagement() {
  ...
  return (
    <div
      id="dish-management-dashboard-view"
      className="bg-[#f8f9ff] text-[#0b1c30] min-h-screen"
    >
      <DashboardHeader
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden p-8 gap-8">
        ...
        <aside className="w-full lg:w-[260px] flex flex-col gap-6 shrink-0">
          ...
          <div className="bg-white p-4 rounded-xl border border-[#bfc8c9]/40 shadow-xs">
            <p className="font-sans text-xs font-semibold uppercase tracking-wider text-[#6f797a] px-2 mb-3">
              Menu Categories
            </p>
        ...
        <main className="flex-grow space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-4 rounded-xl border border-[#bfc8c9]/40">
            <div>
              ...
              <p className="text-xs text-[#6f797a] mt-0.5">
                Manage details and configure availability
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-5 flex-grow space-y-3">
                    <div className="flex justify-between items-start gap-1">
                      ...
                      <span className="font-sans font-extrabold text-sm text-[#00454b]">
                        ₹{dish.price}
                      </span>
                    </div>

                    <p className="font-sans text-xs text-[#6f797a] leading-relaxed line-clamp-2">
                      {dish.description}
                    </p>
                    ...
                    {dish.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1">
                        {dish.tags.map((t) => (
                          <span
                            key={t}
                            className="text-[9px] font-extrabold px-2 py-0.5 bg-[#eff4ff] text-[#00454b] rounded"
                          >
                            {t}
                          </span>
                        ))}
                  ...
                  <div className="p-3 bg-gray-50 border-t border-[#bfc8c9]/25 flex gap-2">
                    ...
                    <button
                      onClick={() => {
                        if (
                          confirm(
                            `Remove ${dish.name} entirely from the branch menu database?`,
                          )
                        ) {
                          deleteDish(dish.id);
                        }
                  ...
                  <tbody className="divide-y divide-[#bfc8c9]/20 text-xs text-[#0b1c30]">
                    {filteredDishes.length === 0 ? (
                      <tr>
                        <td
                          colSpan={5}
                          className="p-8 text-center text-[#6f797a]"
                        >
                      ...
                      filteredDishes.map((dish) => (
                        <tr
                          key={dish.id}
                          className="hover:bg-[#eff4ff]/20 transition-all"
                        >
                          <td className="p-4">
                            <div className="flex gap-4 items-center">
                              ...
                              <div>
                                ...
                                <p className="font-sans text-[11px] text-[#6f797a] mt-0.5 line-clamp-1">
                                  {dish.description}
                                </p>
                              </div>
                            </div>
                          ...
                          <td className="p-4 text-right font-mono font-bold text-[#00454b]">
                            ₹{dish.price}
                          </td>
                          <td className="p-4">
                          ...
                          <td className="p-4 text-center">
                            <div className="inline-flex gap-2">
                              <button
                                onClick={() => handleEditTrigger(dish)}
                                className="p-1 px-2 border border-[#bfc8c9] rounded hover:bg-gray-100"
                              >
                                Edit
                              </button>
                              <button
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  >
                    ...
                    {parentDishes.map((parent) => (
                      <option key={parent["Dish Id"]} value={parent["Dish Id"]}>
                        {parent["Dish Name"]}
                      </option>
                    ))}
                  </select>
